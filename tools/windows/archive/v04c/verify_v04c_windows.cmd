...
echo ==================================================
echo v0.4C Verification
echo Project root: %CD%
echo ==================================================
echo.

if not exist "app\v04c_review.py" goto MISSING_FILES
if not exist "scripts\verify_v04c.py" goto MISSING_FILES
...
set "LOG=%CD%\logs\v04c_verify.log"
echo Python: %PY%
echo Log: %LOG%
echo.
...
:RUN_LAUNCHER
py -3 -X utf8 "scripts\verify_v04c.py" >"%LOG%" 2>&1
set "RC=%ERRORLEVEL%"
goto SHOW_RESULT

:RUN_EXE
"%PY%" -X utf8 "scripts\verify_v04c.py" >"%LOG%" 2>&1
set "RC=%ERRORLEVEL%"
goto SHOW_RESULT
...
echo [OK] v0.4C verification passed.
goto FINISH

:FAILED
echo [ERROR] Verification failed. Exit code: %RC%
