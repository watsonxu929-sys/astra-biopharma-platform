...
echo ==================================================
echo v0.4C-1 verify_v04c1_windows.cmd
echo Project root: %CD%
echo ==================================================
echo.

if not exist "app\v04c1_ingestion.py" goto MISSING_FILES
if not exist "scripts\verify_v04c1.py" goto MISSING_FILES
...
set "LOG=%CD%\logs\verify_v04c1.log"
echo Python: %PY%
echo Log: %LOG%
echo.
...
:RUN_LAUNCHER
py -3 -X utf8 "scripts\verify_v04c1.py" >"%LOG%" 2>&1
set "RC=%ERRORLEVEL%"
goto SHOW_RESULT

:RUN_EXE
"%PY%" -X utf8 "scripts\verify_v04c1.py" >"%LOG%" 2>&1
set "RC=%ERRORLEVEL%"
goto SHOW_RESULT
...
echo [OK] v0.4C-1 verification passed.
goto FINISH
