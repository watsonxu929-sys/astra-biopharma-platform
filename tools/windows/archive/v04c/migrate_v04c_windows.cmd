...
echo ==================================================
echo v0.4C Database Migration
echo Project root: %CD%
echo ==================================================
echo.

if not exist "app\v04c_review.py" goto MISSING_FILES
if not exist "scripts\migrate_v04c.py" goto MISSING_FILES
...
set "LOG=%CD%\logs\v04c_migrate.log"
echo Python: %PY%
echo Log: %LOG%
echo.
...
:RUN_LAUNCHER
py -3 -X utf8 "scripts\migrate_v04c.py" >"%LOG%" 2>&1
set "RC=%ERRORLEVEL%"
goto SHOW_RESULT

:RUN_EXE
"%PY%" -X utf8 "scripts\migrate_v04c.py" >"%LOG%" 2>&1
set "RC=%ERRORLEVEL%"
goto SHOW_RESULT
...
echo [OK] v0.4C migration completed.
goto FINISH

:FAILED
echo [ERROR] Migration failed. Exit code: %RC%
...
echo Required:
echo   app\v04c_review.py
echo   scripts\migrate_v04c.py
set "RC=2"
goto FINISH
