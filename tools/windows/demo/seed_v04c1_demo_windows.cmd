...
echo ==================================================
echo v0.4C-1 seed_v04c1_demo_windows.cmd
echo Project root: %CD%
echo ==================================================
echo.

if not exist "app\v04c1_ingestion.py" goto MISSING_FILES
if not exist "scripts\seed_v04c1_demo.py" goto MISSING_FILES
...
set "LOG=%CD%\logs\seed_v04c1_demo.log"
echo Python: %PY%
echo Log: %LOG%
echo.
...
:RUN_LAUNCHER
py -3 -X utf8 "scripts\seed_v04c1_demo.py" >"%LOG%" 2>&1
set "RC=%ERRORLEVEL%"
goto SHOW_RESULT

:RUN_EXE
"%PY%" -X utf8 "scripts\seed_v04c1_demo.py" >"%LOG%" 2>&1
set "RC=%ERRORLEVEL%"
goto SHOW_RESULT
...
echo [OK] v0.4C-1 demo data created.
goto FINISH
...
echo   scripts\seed_v04c1_demo.py
set "RC=2"
goto FINISH
