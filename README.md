...
P4 已完成统一会员生命周期、活动报名审核、Token/手工签到、结构化反馈、统一供需沉淀、资源匹配候选、会后关系候选、ClubLead 候选与中文运营看板。`007_club_operations_mvp.py` 默认 dry-run；受控试点只在数据库副本运行，正式库未应用 007、未写入试点数据、未创建 Opportunity。详见 `docs/p4/`。
