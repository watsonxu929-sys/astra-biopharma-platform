...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    cap("workspace.recent_followups", "最近跟进", "跟进", "最近商务跟进", "workspace", "workspace", "/platform#followups", "/api/v1/opportunities", "message-square", order=13),
    cap("workspace.favorites", "我的收藏", "收藏", "收藏和关注", "workspace", "workspace", "/platform#favorites", "/api/v1/collection", "bookmark", order=14),
    ...
    cap("network.organizations", "企业与机构", "企业与机构", "企业和机构目录", "network", "network", "/network", "/api/v1/subjects/organizations", "building-2", order=21, legacy=("/network/organizations",)),
    cap("network.people", "人物", "人物", "产业人物目录", "network", "network", "/network/people", "/api/v1/network/people", "users", order=22, legacy=("/people",)),
    cap("network.graph", "关系视图", "关系视图", "主体关系图谱、路径查询和时间线", "network", "network", "/network/graph", "/api/v1/relationships", "share-2", order=23),
    cap("network.governance", "主体治理", "治理", "主体消歧、重复合并和关系审核", "network", "network", "/network/governance", "/api/v1/subjects/people", "users-round", "edit_data", clients=("web", "admin"), order=24),
    cap("network.recommendations", "连接建议", "连接建议", "基于现有关系路径的连接建议", "network", "network", "/network/recommendations", "/api/v1/network/recommendations/people", "sparkles", "use_recommendations", order=25),
    ...
    cap("collaboration.opportunities", "进行中的跟进", "进行中", "合作机会管理和阶段推进", "collaboration", "collaboration", "/opportunities", "/api/v1/opportunities", "handshake", order=53),
    cap("collaboration.tasks", "行动任务", "任务", "协作任务和商务跟进记录", "collaboration", "collaboration", "/collaboration/tasks", "/api/v1/opportunities", "list-checks", order=54),
    ...
    cap("club", "俱乐部", "俱乐部", "Q-BAY产业社区运营场景", "club", None, "/club", "/api/v1/me/club-context", "landmark", order=40),
