...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    cap("intelligence.raw_items", "原始情报", "原始", "采集到的标题、正文、来源链接和快照", "intelligence", "intelligence", "/collection/items", "/api/v1/collection/items", "file-search", "manage_monitoring", clients=("web", "admin"), order=39),
    cap("intelligence.processing", "数据处理", "处理", "清洗、结构化和实体识别", "intelligence", "intelligence", "/processing/jobs", "/api/v1/processing", "workflow", "review_data", clients=("web", "admin"), order=40),
    cap("intelligence.candidates", "候选匹配", "候选", "实体、字段和主体候选匹配", "intelligence", "intelligence", "/processing/candidates", "/api/v1/processing/candidates", "git-compare", "review_data", clients=("web", "admin"), order=41),
    cap("intelligence.review", "情报审核", "审核", "候选审核和发布", "intelligence", "intelligence", "/admin/intelligence", "/api/v1/intelligence", "shield-check", "review_data", clients=("web", "admin"), order=42, legacy=("/review",)),
    cap("intelligence.signals", "产业信号", "信号", "产业信号", "intelligence", "intelligence", "/signals", "/api/v1/signals", "activity", "review_data", clients=("web", "admin"), order=43),
    cap("intelligence.reports", "报告中心", "报告", "报告和研究", "intelligence", "intelligence", "/reports", "/api/v1/reports", "file-text", "review_data", clients=("web", "admin"), order=44),
